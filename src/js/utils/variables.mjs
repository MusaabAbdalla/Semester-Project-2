...
export const API_LISINGS="/auction/listings"
export const API_KEY_URL = "/create-api-key";
export const API_KEY = "3e0e9ac4-1b9e-48c4-b53c-644607708993";

// const loginEndpoint = "/social/auth/login";
// const registerEndpoint = "/social/auth/register";
// const allPostsEndpoint =
//   "/social/posts?_author=true&_comments=true&_reaction=true";
